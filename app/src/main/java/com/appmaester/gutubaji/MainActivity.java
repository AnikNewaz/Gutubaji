package com.appmaester.gutubaji;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rollButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("Gutibaji", "Dices has been rolled!");
                Random randomNumGeneratior = new Random();
                int leftNum = randomNumGeneratior.nextInt(6);
                int rightNum = randomNumGeneratior.nextInt(6);
